    ...
    def into(self):
        if((self.txt_name.text() != '') and (self.txt_age.text() != '') and (self.txt_phone.text() != '') and (self.txt_address.text() != '')):
            try:
                ...
                self.cmd = "insert into membership(name, age, phone, address) values('{}','{}','{}','{}')".format(self.txt_name.text(),self.txt_age.text(),self.txt_phone.text(),self.txt_address.text())
                print(self.cmd)
...
class sql(QWidget):
        ...
        if (self.txt_number.text() != ""):
            try:
                ...
                if agree == QMessageBox.Yes:
                    self.cmd = "delete from membership where no = '{}'".format(self.txt_number.text())
                    print(self.cmd)
    ...
    def edit(self):
        if (self.txt_name.text() != "") and (self.txt_age.text() != "") and (self.txt_phone.text() != "") and (self.txt_address.text() != ""):
            try:
                self.cmd = "update membership set name = '{}', age = '{}', phone = '{}', address = '{}' where no = {}" \
                    .format(self.txt_name.text(), self.txt_age.text(), self.txt_phone.text(), self.txt_address.text(), self.txt_number.text())
